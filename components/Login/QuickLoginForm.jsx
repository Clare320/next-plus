...
export default function QuickLoginForm() {
  return (
    <form className={styles.form_quicklogin}>
      <div className={styles.input_container}>
        <input type="text" id="phone" className={styles.form_input} placeholder="手机号码" maxLength={11} />
      </div>
      <div className={styles.input_container}>
        <input type="text" id="verifycode" className={styles.form_input} placeholder="验证码" />
